...
country = {
	...
	BASE_MONTHLY_DIPLOPOINTS = 1.0, -- Base value gain for diplomatic actions each month
...
military = {
	...
	AI_SUPPORT_PROPORTION = 0.70, -- fraction of brigades that should be artillery and other support units
